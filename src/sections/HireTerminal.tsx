...
const AVAILABLE_COMMANDS: Record<string, Command> = {
  ...
  projects: {
    ...
    output: [
      ...
      '',
      '2. ASX-Grounded RAG Agent',
      '   → Cited Q&A, hybrid retrieval, hallucination eval',
      '',
      '3. Tradie Receptionist',
      '   → AI voice agent, Vapi + Twilio + Groq, <30s lead SMS',
      '',
      '4. Graph-QA Agent (LLM + Neo4j)',
